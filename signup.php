                ...
                <div class="row latest-job margin-top-50 margin-bottom-20">
                    ...
                    <div class="col-md-6 latest-job">
                        <div class="small-box bg-yellow padding-5">
                            <div class="inner">
                                <h3 class="text-center">Applicants Signup</h3>
                            </div>
                            <a href="register_applicants.php" class="small-box-footer">Signup <i class="fa fa-arrow-circle-right"></i> </a>
                        </div>
                    </div>
                    <div class="col-md-6 latest-job">
                        <div class="small-box bg-red padding-5">
                            <div class="inner">
                                <h3 class="text-center">Company Signup</h3>
                            </div>
                            <a href="register_company.php" class="small-box-footer">Signup <i class="fa fa-arrow-circle-right"></i> </a>
                        </div>
                    </div>
                </div>
            </div>
