              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                    <?php
                     $sql = "SELECT * FROM job_posts WHERE company_id='$_SESSION[company_id]'";
                      ...
                      <tr>
                        ...
                        <td><a href="view-job-post.php?id=<?php echo $row['jobpost_id']; ?>"><i class="fa fa-address-card-o"></i></a></td>
                      </tr>
                      <?php
                       }
                     }
